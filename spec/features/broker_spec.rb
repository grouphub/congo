...
describe 'As a broker', js: true do
  ...
  describe 'Carrier Accounts' do
    ...
    it 'allows them to link their account to a carrier'
    it 'allows them to delete the carrier account'

  end

  describe 'Benefit Plans' do

    it 'allows them to create a benefit plan'
    it 'allows them to delete a benefit plan'
    it 'allows them to view a benefit plan'
    it 'allows them to enable and disable a benefit plan'
  ...
  describe 'Account Settings' do
    ...
    it 'allows them to update their account settings'

  end

  describe 'Check Eligibility' do

    it 'allows them to check eligibility'
